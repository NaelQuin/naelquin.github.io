...
const config: Config = {
  ...
  url: 'https://git.ipiaget.org/psytech/education-dashboard',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/education-dashboard/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'PsyTech - INSIGHT', // Usually your GitHub org/user name.
  projectName: 'education-dashboard', // Usually your repo name.
